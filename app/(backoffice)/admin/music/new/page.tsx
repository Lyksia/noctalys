...
export default function NewMusicPage() {
  ...
  const handleTitleChange = (value: string) => {
    setFormData((prev) => ({
      ...prev,
      title: value,
      // Auto-générer le slug si pas modifié manuellement
  ...
  const handleSubmit = async (e: React.FormEvent, isDraft = false) => {
    ...
    try {
      ...
      toast.success("Morceau créé avec succès");
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-heading-1 font-serif font-semibold">Nouvelle musique</h1>
        <p className="text-moon-400">Ajouter un nouveau morceau à votre bibliothèque</p>
      </div>
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Renseignez les détails de votre musique</CardDescription>
              </CardHeader>
